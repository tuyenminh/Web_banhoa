...
if (isset($_SESSION['cart'])) {
    ...
    $sql = "SELECT*FROM sanphams WHERE sp_id IN($str_id)";
...
?>
    ...
    <div id="my-cart">
        ...
        <form method="post">
            ...
            while ($row = mysqli_fetch_array($query)) {
                $total_price = $_SESSION['cart'][$row['sp_id']] * $row['sp_gia'];
            ...
            ?>
                <div class="cart-item row">
                    ...
                    <div class="cart-quantity col-lg-2 col-md-2 col-sm-12">
                        <input name="qtt[<?php echo $row['sp_id']; ?>]" type="number" id="quantity" class="form-control form-blue quantity" value=<?php echo $_SESSION['cart'][$row['sp_id']]; ?> min="1">
                    </div>
                    <div class="cart-price col-lg-3 col-md-3 col-sm-12"><b><?php echo $total_price; ?></b><a href="modules/cart/cart_dell.php?prd_id=<?php echo $row['sp_id']; ?>">Xóa</a></div>
    ...
    if (isset($_POST["name"]) && isset($_POST["phone"]) && isset($_POST["mail"]) && isset($_POST["add"])) {
        ...
        while ($row = mysqli_fetch_array($query)) {
            ...
            $str_body .= '
            <tr>
                <td width="70%">' . $row["sp_ten"] . '</td>
                <td width="10%">' . $_SESSION["cart"][$row["sp_id"]] . '</td>
