        ...
        <div class="row text-center">
          ...
          <div class= "col-3">
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
              <button class="btn btn-outline-success fw-bolder" style = "margin-top: 50px;" type="button">ĐỔI MẬT KHẨU</button>
              <button class="btn btn-outline-success fw-bolder" style = "margin-top: 50px;" type="button">ĐĂNG XUẤT</button>
            </div>
          </div>
      </div>
    </nav>
